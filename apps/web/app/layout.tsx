...
export const metadata: Metadata = {
  ...
  other: {
    // Reissued 2026-08-02 when the app was registered through the Base Dashboard
    // /register flow. The previous id (6a668e04281b6db318994d46) belonged to the
    // July registration attempt and no longer matches the app being verified.
    'base:app_id': '6a6f93a5a8c4f2b6db3b3e11',
